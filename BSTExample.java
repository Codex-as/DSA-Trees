...
class BSTOperation {
     ...
     System.out.println(node == null ? "Not data found" : "data Found" + node.data);
    ...
    int minValue(BSTNode<Integer> currentNode){
        if(currentNode  == null) return Integer.MIN_VALUE;
...
public class BSTExample {
    public static void main(String[] args) {
        BSTOperation opt = new BSTOperation();
        opt.takeValue();
    }
}
